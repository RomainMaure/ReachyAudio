...
class ReachyAudioTextToSpeech():
    ...
    def diode(self, signalArray):
        """ Apply an approximation of the diode non linearity
    ...
    def diodeRingModulator(self, intputFileName):
        """ Alter the audio file containing the text to be said
            to make it sounds more robotic like.
            Simulate a diode ring modulator electrical circuit.

            :param intputFileName: Name of the audio file containing
                                   the voice to be altered.
